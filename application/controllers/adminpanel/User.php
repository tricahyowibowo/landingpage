...
class User extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->loadViews("adminpanel/dashboard", $this->global , NULL);
    }
    ...
    function editUser()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if(empty($password))
                {
                    $userInfo = array('username'=>$username, 'roleId'=>$roleId, 'name'=>$name, 'updatedBy'=>$this->vendorId, 'updatedDtm'=>date('Y-m-d H:i:s'));
                }
                else
                {
