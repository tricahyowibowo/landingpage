...
<section class="layanan">
  ...
  <div class="page-content">
    <div  data-aos="zoom-in-right" data-aos-delay="300" data-aos-duration="2000" class="card-desc" style="background: url(<?php echo base_url().'assets/landingpage/images/tentangkami.webp'?>); background-repeat: no-repeat; background-size:cover ;background-position: center;">
    ...
    <div  data-aos="zoom-in-right" data-aos-delay="400" data-aos-duration="2000" class="card-desc" style="background: url(<?php echo base_url().'assets/landingpage/images/produkkami_edit.png'?>); background-repeat: no-repeat; background-size:cover ;background-position: center;">
      <div class="content-desc">
    ...
    <div   data-aos="zoom-in-left" data-aos-delay="500" data-aos-duration="2000" class="card-desc" style="background: url(<?php echo base_url().'assets/landingpage/images/kunjunganindustri_edit.png'?>); background-repeat: no-repeat; background-size:cover ;background-position: center;">
      <div class="content-desc">
    ...
    <div   data-aos="zoom-in-left" data-aos-delay="600" data-aos-duration="2000" class="card-desc" style="background: url(<?php echo base_url().'assets/landingpage/images/maklon_edit.png'?>); background-repeat: no-repeat; background-size:cover ;background-position: center;">
      <div class="content-desc">
